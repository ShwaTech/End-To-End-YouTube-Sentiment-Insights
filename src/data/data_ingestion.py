...
def main():
    try:
        ...
        os.makedirs(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../artifacts/dataset/'), exist_ok=True)
        
        # Save the split datasets and create the raw folder if it doesn't exist
        save_data(train_data, test_data, data_path=os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../artifacts/dataset/'))
