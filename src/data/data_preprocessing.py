...
def main():
    try:
        ...
        train_data = pd.read_csv('./artifacts/dataset/raw/train.csv')
        test_data = pd.read_csv('./artifacts/dataset/raw/test.csv')
        ...
        save_data(train_processed_data, test_processed_data, data_path='./artifacts/dataset')
    except Exception as e:
