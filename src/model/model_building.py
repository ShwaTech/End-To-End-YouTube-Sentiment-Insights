...
def apply_tfidf(train_data: pd.DataFrame, max_features: int, ngram_range: tuple) -> tuple:
    ...
    try:
        ...
        # Create the vectorizer directory if it doesn't exist
        os.makedirs(os.path.join(get_root_directory(), 'artifacts/vectorizer'), exist_ok=True)

        # Save the vectorizer in the root directory
        with open(os.path.join(get_root_directory(), 'artifacts/vectorizer/tfidf_vectorizer.pkl'), 'wb') as f:
...
def main():
    try:
        ...
        train_data = load_data(os.path.join(root_dir, 'artifacts/dataset/interim/train_processed.csv'))
        ...
        os.makedirs(os.path.join(root_dir, 'artifacts/model'), exist_ok=True)

        # Save the trained model in the root directory
        save_model(best_model, os.path.join(root_dir, 'artifacts/model/lgbm_model.pkl'))
